...
const Coze = () => {
    ...
    const workflow_id = '7533134933922938931';
    const updateImageData = () => {
        ...
        reader.readAsDataURL(file);  //html5 用于读取图片内容
        reader.onload = (e) => { 
            // base64 待图片加载完成之后 
   ...
   const uploadFile = async () => {
        ...
        const res = await fetch(uploadUrl, { 
            method: 'POST',
            headers: { 'Authorization': `Bearer pat_g5YfijBMzW51lRBXfTtmkuqAhqo2XBDEXZWJZAZj2BvZqdQRI4UJOv2ThD3c4L1k`, }, 
            body: formData, 
        });
    ...
    const generate = async () => {
        ...
        const res = await fetch(workflowUrl, {
            method: 'POST',
            headers: { 
                Authorization: `Bearer pat_g5YfijBMzW51lRBXfTtmkuqAhqo2XBDEXZWJZAZj2BvZqdQRI4UJOv2ThD3c4L1k`, 
